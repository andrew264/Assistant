...
class Fun(commands.Cog):
	...
	async def pp(
		...
		user: Member = Param(description= "Mention a User",
		...
		if pp404 is not None: ppembed.add_field(name="There is no sign of PP in here.", value='\u200b')
	...
	async def kill(self,
		...
		else: killembed.add_field(name=DeathMsgGen(user.display_name, inter.author.display_name), value='\u200b')
